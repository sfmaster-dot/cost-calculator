  ...
  return (
    <div style={{ display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", minHeight:"100vh", padding:"32px 24px", background:"var(--bg)" }}>
      <div style={{
        ...
        {/* 로고 */}
        <img src={LOGO_SRC} alt="단꿈" style={{ width:64, height:64, objectFit:"contain", marginBottom:20 }} />
...
function StoreScreen({ user, stores, onSelect, onDelete, addingStore, setAddingStore, newStoreName, setNewStoreName, newStoreColor, setNewStoreColor, onAddStore, onLogout }: any) {
  ...
  return (
    <div style={{ maxWidth: 620, margin: "0 auto", padding: "56px 20px 80px" }}>
      ...
      {/* 앱 타이틀 */}
      <div className="rise" style={{ animationDelay:"0s", display:"flex", alignItems:"center", gap:12, marginBottom:40 }}>
        <img src={LOGO_SRC} alt="단꿈" style={{ width:40, height:40, objectFit:"contain" }} />
        <div>
          <div style={{ fontSize:17, fontWeight:900, lineHeight:1.2 }}>단꿈 <span style={{ color:"var(--accent)" }}>원가율</span> 계산기</div>
          <div style={{ fontSize:12, color:"var(--text-sub)", marginTop:3 }}>장사 최적화의 첫걸음, 원가율에서 시작됩니다</div>
        </div>
      </div>

      {/* 헤더 */}
      <div className="rise" style={{ animationDelay: "0.06s", display:"flex", justifyContent:"space-between", alignItems:"flex-end", marginBottom:36 }}>
        <div>
